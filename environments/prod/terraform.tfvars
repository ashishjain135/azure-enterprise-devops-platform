...
vnets = {
  vnet1 = {
    name                = "vnet-aedp-prod"
    location            = "centralindia"
    resource_group_name = "rg-aedp-prod"
...
subnets = {
  snet1 = {
    ...
    resource_group_name  = "rg-aedp-prod"
    virtual_network_name = "vnet-aedp-prod"
...
vms = {
  frontend_1 = {
    ...
    location        = "centralindia"
    rg_name         = "rg-aedp-prod"
    nic_subnet_name = "frontend-subnet-prod"
    nic_vnet_name   = "vnet-aedp-prod"
    vm_name         = "frontend-vm-1-prod"
    vm_size         = "Standard_B1s"
    admin_username  = "devopsadmin"
    key_vault_name  = "kv-aedp-prod-123"
